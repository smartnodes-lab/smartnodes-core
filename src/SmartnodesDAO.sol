...
// /**
//  * @title SmartnodesDAO
//  * @dev DAO contract for governance using unclaimed rewards as voting power
//  * @dev Manages proposals for SmartnodesCore upgrades and network management
//  */
...
//     /** State Variables */
//     ISmartnodesToken public immutable tokenContract;
//     ProxyAdmin public immutable proxyAdmin;
//     TransparentUpgradeableProxy public immutable smartnodesCoreProxy;
...
//         address _proxyAdmin,
//         address _smartnodesCoreProxy
//     ) Ownable(msg.sender) {
//         tokenContract = ISmartnodesToken(_tokenContract);
//         proxyAdmin = ProxyAdmin(_proxyAdmin);
//         smartnodesCoreProxy = TransparentUpgradeableProxy(
//             payable(_smartnodesCoreProxy)
//         );
//     }

//     /**
//      * @notice Create a new proposal for upgrading SmartnodesCore
...
//             id: proposalId,
//             proposer: msg.sender,
//             proposalType: ProposalType.UPGRADE_CORE,
...
//             targetContract: address(proxyAdmin),
//             executed: false
//         });
...
//             executionData: executionData,
//             description: _description,
//             targetContract: address(smartnodesCoreProxy),
//             executed: false
//         });
...
//         uint256 totalUnclaimedRewards = tokenContract.s_totalTokensUnclaimed();

//         // Check quorum
//         bool quorumReached = (totalVotes * 100) >=
//             (totalUnclaimedRewards * QUORUM_PERCENTAGE);
...
//         return tokenContract.getUnclaimedRewards(_user);
//     }
